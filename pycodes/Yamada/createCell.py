...
def createCell(tf, amp, dur, delay=0, hh2=True, pas=True, im=False, il=False, it=False):
    soma = create_soma()
    soma = insert_mechanisms(soma, hh2=hh2, pas=pas, im=im, il=il, it=it)
    time, voltage, stim, channels = simConfig(soma, tf, amp, dur, delay, return_channels=True)
...
time, voltage, stim_current, channels = createCell(tf, amp, dur, delay, hh2=True, pas=True, im=gm)
